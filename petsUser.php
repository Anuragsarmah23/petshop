        ...
        <nav class="navbar navbar-expand-sm navbar-default" style="background:#c725e3;">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="active">
						<a href="petsUser.php"><i class="menu-icon fa fa-paw"></i>Pets</a>
					</li>
                    <li class="menu-title">
                        <a href="suppliesUser.php" class="text-light"><i class="menu-icon fa fa-address-book text-light"></i>Supplies </a>
                    </li>
					<li class="menu-title">
