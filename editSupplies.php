...
<html>
	<head>
		<title>EDIT SUPPLY|PET SHOP</title>
	...
	<body>
		...
		<div class="formMain">
			<div class="regFormElements">
				...
				<form method="post" class="regForm" id="validateIt" action="updateSupplies.php">
				<div class="row">
					  <?php
							$id=$_GET["id"];
							$_SESSION["supplyID"]=$id;
					  ...
					  <div class="form-group col-md-6">
						...
						<input type="text" name="item" class="form-control" id="item" disabled value="<?php echo $row["item"]; ?>" style="background:transparent;">
					  </div>
					  <div class="form-group col-md-6">
