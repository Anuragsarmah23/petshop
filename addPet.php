	...
	<body>
		...
		<div class="formMain">
			<div class="regFormElements">
				...
				<form method="post" class="regForm" id="validateIt" action="addPetParse.php" enctype="multipart/form-data">
				<div class="row">
					  ...
					  <div class="form-group col-md-6">
						...
						<input type="text" name="breed" class="form-control" id="breed" data-rule-required="true" data-msg-required="Please Enter Breed" placeholder="Enter Breed">
					  </div>
					  <div class="form-group col-md-6">
