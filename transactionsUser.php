...
<head>
    ...
    <title>TRANSACTIONS|PET SHOP</title>
        ...
        <nav class="navbar navbar-expand-sm navbar-default" style="background:#c725e3;">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
					...
					<li class="active">
						<a href="transactionsUser.php"><i class="menu-icon fa fa-history"></i>Transactions</a>
					</li>
                </ul>
            </div>
        </nav>
        ...
        <div class="content">
            ...
            <div class="card" style="min-height:82vh;padding:20px;margin-top:-1px;width:100%;">
							...
							<?php
								...
								if(!$con)
									die("Error");
								$q="select * from transaction where customerID='$id'";
