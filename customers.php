...
<body>
        ...
        <nav class="navbar navbar-expand-sm navbar-default" style="background:#c725e3;">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="active">
						<a href="customers.php"><i class="menu-icon fa fa-users"></i>Customers</a>
					</li>
                    <li class="menu-title">
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content">
            <div class="row">
						<div class="card" style="min-height:82vh;padding:20px;margin-top:-1px;">
							<div class="card-header">Customer List <a href="register.php"><i class="fa fa-user-plus pull-right text-primary" style="cursor:pointer;">&nbsp;ADD NEW</i></a></div><br>
							<?php
								//Radhe
								...
								<table id="customersList" class="table table-striped table-bordered bg-white" style="width:100%">
									...
									?>
										<tr>
											...
											<td><a href="editCustomer.php?id=<?php echo $row['id']; ?>"><i class="fa fa-edit editI"></i></a></td>
											<td><a href="delCustomer.php?id=<?php echo $row['id']; ?>"><i class="fa fa-trash delI"></i></a></td>
										</tr>	
									<?php
										}
									?>	
