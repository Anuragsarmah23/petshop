        ...
        <nav class="navbar navbar-expand-sm navbar-default" style="background:#c725e3;">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-title">
						<a href="productsUser.php" class="text-light"><i class="menu-icon fa fa-paw text-light"></i>Products</a>
					</li>
                    <li class="menu-title">
						...
						<div class="col-md-12">
							<div class="card">
								...
								<div class="content" style="padding:20px;">
									<form action="updateCustomerC.php" method="post">
										<div class="row">
											<div class="col-md-6">
										...
										<div class="row">	
											...
											<div class="col-md-6">
												<div class="form-group">
													<label>City</label>
													<select name="city" name="city" class="form-control city" data-rule-required="true" data-msg-required="Please select your city">
										...
										<div class="row">
											<div class="col-md-6">
												<div class="form-group">
													<label>State</label>
													<input type="text" class="form-control" placeholder="State" disabled value="<?php echo $row["state"]; ?>">
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
													<label>Pin</label>
													<input type="text" class="form-control" name="pin" placeholder="Pin" value="<?php echo $row["pin"]; ?>">
												</div>
											</div>
										</div>	
										<div class="row">
											<div class="col-md-6">
												<div class="form-group">
													<label>Contact</label>
													<input type="text" class="form-control" name="cno" placeholder="Home Address" value="<?php echo $row["contact"]; ?>">
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
